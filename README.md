...
>
> 🎉 **如果您是普通用户，想要直接使用 Robou，请前往主仓库下载完整客户端：**
>
> | 平台                                                                                                         | 链接                                                                      |
> | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
...
Robou Web 提供了完整的短剧创作前端界面，包含以下核心模块：
...
| ------------------------------------------- | -------------- | -------------------------------------------------- | ------------------------------------------------- |
| 🎬 **普通用户** - 想直接使用 Robou 创作短剧 | 下载完整客户端 | [Robou-app](https://github.com/HBAI-Ltd/Robou-app) | [Robou-app](https://gitee.com/HBAI-Ltd/Robou-app) |
...
- ✅ **后端服务**：确保 Robou 后端服务已启动并可访问（可从 [GitHub](https://github.com/HBAI-Ltd/Robou-app) 或 [Gitee](https://gitee.com/HBAI-Ltd/Robou-app) 获取）
...
> 💡 **提示**：后端服务可从 [GitHub](https://github.com/HBAI-Ltd/Robou-app) 或 [Gitee](https://gitee.com/HBAI-Ltd/Robou-app) 仓库获取。
...
| 仓库          | 说明                             | GitHub                                          | Gitee                                         |
| ------------- | -------------------------------- | ----------------------------------------------- | --------------------------------------------- |
| **Robou-app** | 完整客户端（推荐普通用户）       | [GitHub](https://github.com/HBAI-Ltd/Robou-app) | [Gitee](https://gitee.com/HBAI-Ltd/Robou-app) |
| **Robou-web** | 前端源代码（本仓库，适合开发者） | [GitHub](https://github.com/HBAI-Ltd/Robou-web) | [Gitee](https://gitee.com/HBAI-Ltd/Robou-web) |
...
📧 邮箱：[ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=Robou前端咨询)

---

# 📜 许可证

Robou Web 基于 AGPL-3.0 协议开源发布，许可证详情：https://www.gnu.org/licenses/agpl-3.0.html

您可以在遵循 AGPL-3.0 相关条款与条件的情况下，将 Robou Web 用于包括商业目的在内的各类用途。
